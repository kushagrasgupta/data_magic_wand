...
from whooshql.api.merger import execute_local_merge, plan_local_merge
from whooshql.api.sort import sort_frame
from whooshql.api.validate import validate_frame
from whooshql.infer import (
...
def test_validate_frame_json_schema() -> None:
    ...
    assert "_whooshql_errors" in result.bad.collect(engine="streaming").columns
...
def test_infer_helpers_and_markdown_report() -> None:
    ...
    assert "# whooshql Profile" in markdown
