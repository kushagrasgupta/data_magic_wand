...
app = typer.Typer(help="whoosh: polars-native data processing toolbox")


@app.callback(invoke_without_command=True)
def _root(
    ctx: typer.Context,
    version: bool = typer.Option(False, "--version", help="Show whoosh version"),
) -> None:
    if version:
